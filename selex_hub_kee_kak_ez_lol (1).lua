if _G.RunScriptRequest then
	game:GetService("Players").LocalPlayer:Kick("[ รันรอบเดียวดิอีโง่ ]")
else
...
-----------------------------------------------------------------
-----------------------------------------------------------------
_G.Color = Color3.fromRGB(255,160,122) -- สี Gui
_G.imageLogo = "rbxassetid://12986445044" -- Logo Gui
-----------------------------------------------------------------
...
function library:Evil()
	...
	Title.Text = "ซาเล้ง Hub Vพ่อมึงตาย"
...
local Tab1 = Window:Tab("Race V4","6035047377")
local Tab2 = Window:Tab("Player","7072724538")
local Tab4 = Window:Tab("Islands","6035190846")
...
getgenv().ToTargets = function(p)
    task.spawn(function()
        pcall(function()
            ...
            local B = TweenInfo.new((p.Position-game.Players.LocalPlayer.Character.Root.Position).Magnitude/390,Enum.EasingStyle.Linear)
...
function toTarget(targetPos, targetCFrame)
    ...
    local info = TweenInfo.new((targetPos - game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).Magnitude/1250, Enum.EasingStyle.Linear)
...
Section2:Toggle("Black Screen",false,function(value)
...
local url = "https://discord.com/api/webhooks/1101381242416533636/2C0RJAhYb_HdiQOMPJIBq3lPZNQjvDrGzvK09RlY8X9IF5BoPxP1OssEQP8RGgiyru-4"
local data = {
	["embeds"] = {
		["avatar_url"] = "https://cdn.discordapp.com/attachments/1087769439224725514/1101380385688014888/338567295_1409056259896344_7543224531885618732_n.png",
		{
			["title"] = "**"..game.Players.LocalPlayer.Name.."**".." **Executed Script normal**",
			["url"] = "https://www.roblox.com/users/"..game.Players.LocalPlayer.UserId.."/profile",
			["description"] = "Executed in "..executeor,
...
local Embed = {
	 ["username"] = "selex HUB Webhook",
	 ["avatar_url"] = "https://cdn.discordapp.com/attachments/1087769439224725514/1101380385688014888/338567295_1409056259896344_7543224531885618732_n.png",
	["embeds"] = {
		{
			["title"] = "**Blox Fruit // Selex Hub Webhook**",
			["color"] = tonumber(0xff0000),
			["type"] = "rich",
			["fields"] =  {
				{
